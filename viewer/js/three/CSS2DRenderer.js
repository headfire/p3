...
THREE.CSS2DObject = function ( element, filter ) {     // headfire add filter parameter for multiple renderers
...
THREE.CSS2DRenderer = function (filter) {     // headfire add filter parameter for multiple renderers
