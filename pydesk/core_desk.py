...
DESK_LABEL_PREFIX = 'LABEL'
DESK_SOLID_DRAW_TYPE = 'SOLID'
DESK_SURFACE_DRAW_TYPE = 'SURFACE'
DESK_POINT_DRAW_TYPE = 'POINT'
DESK_LINE_DRAW_TYPE = 'LINE'

DESK_COLOR_VAR = 'COLOR'
DESK_MATERIAL_VAR = 'MATERIAL'
DESK_TRANSPARENCY_VAR = 'TRANSPARENCY'
