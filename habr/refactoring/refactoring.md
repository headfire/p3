...
должен все ближе и ближе отражать суть моделируемых и контроллируемых событий. 
...
Проблема в том, что суть словами не описать. Как говорили мудрецы прошлого - 
...
А сама суть постигается при какой-либо практической деятельности. В этом
вся сложность и есть.
...
Наша система должна справлятся с внешними воздействиями. Когда к ней добавляются
еще и внутренние изменения - мы можем не вписаться в поворот.
